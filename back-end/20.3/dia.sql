...
DELIMITER ;
/* ex2 Crie um Trigger para UPDATE que, ao receber uma alteração na tabela movies , 
deve comparar o valor anterior de ticket_price com o valor sendo inserido nesta atualização.
 Caso o valor seja maior que o anterior, insira na coluna ticket_price_estimation o valor de 
 'Increasing' . Caso contrário, insira o valor 'Decreasing' . 
...
onde deve ser guardada a data da exclusão, a executed_action 'DELETE' e o id do filme excluído.*/
...
FOR EACH ROW 
BEGIN 
INSERT INTO movies.logs(movie_id, executed_action, log_date)
