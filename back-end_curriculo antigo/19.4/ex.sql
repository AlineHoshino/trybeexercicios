...
/* ex 2  Procurando Nemo foi aclamado pela crítica! Foi classificado em 6.8, 
...
/*ex3 O diretor do filme "Procurando Nemo" está incorreto, na verdade ele foi dirigido por Andrew Staton. 
Corrija esse dado utilizando o UPDATE .*/
UPDATE Movies
SET director = 'Andrew Staton'
WHERE title = 'Procurando Nemo';
/* ex 4 O título do filme "Ratatouille" esta escrito de forma incorreta na tabela Movies ,
...
/* ex 7 Exclua da tabela Movies todos os filmes dirigidos por "Andrew Staton".*/
DELETE FROM BoxOffice
