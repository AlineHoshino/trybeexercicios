...
//trim tira os espaços antes e depois exemplo"      aline    " fica "aline"
...
//d pega o número, ^e $ faz pegar direto o digito
...
//split fica assim[12,02,2020], pega cada posição e coloca numa variavel para comparar
...
function getSelectedOption(select){
  return select.options[select.selectedIndex];//selectedindex ve o indice do elemento selecionado
}
